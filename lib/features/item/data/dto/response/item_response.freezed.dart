...
@JsonKey(name: 'item_id') String get itemId;@JsonKey(name: 'item_name') String get itemName;@JsonKey(name: 'type_name') String get typeName;@JsonKey(name: 'unit_name') String get unitName;@JsonKey(name: 'minimum_stock') int get minimumStock; String get image; int get stock;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,itemId,itemName,typeName,unitName,minimumStock,image,stock);

@override
String toString() {
  return 'ItemResponse(itemId: $itemId, itemName: $itemName, typeName: $typeName, unitName: $unitName, minimumStock: $minimumStock, image: $image, stock: $stock)';
}
...
@useResult
$Res call({
@JsonKey(name: 'item_id') String itemId,@JsonKey(name: 'item_name') String itemName,@JsonKey(name: 'type_name') String typeName,@JsonKey(name: 'unit_name') String unitName,@JsonKey(name: 'minimum_stock') int minimumStock, String image, int stock
});
...
/// Create a copy of ItemResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? itemId = null,Object? itemName = null,Object? typeName = null,Object? unitName = null,Object? minimumStock = null,Object? image = null,Object? stock = null,}) {
...
class _ItemResponse implements ItemResponse {
  const _ItemResponse({@JsonKey(name: 'item_id') required this.itemId, @JsonKey(name: 'item_name') required this.itemName, @JsonKey(name: 'type_name') required this.typeName, @JsonKey(name: 'unit_name') required this.unitName, @JsonKey(name: 'minimum_stock') required this.minimumStock, required this.image, required this.stock});
...
/// Create a copy of ItemResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? itemId = null,Object? itemName = null,Object? typeName = null,Object? unitName = null,Object? minimumStock = null,Object? image = null,Object? stock = null,}) {
