...
class _UserApi implements UserApi {
  ...
  Future<ApiResponse<PaginatedResponse<UserResponse>>> getUsers({
    ...
    final _options =
        _setStreamType<ApiResponse<PaginatedResponse<UserResponse>>>(
    ...
    late ApiResponse<PaginatedResponse<UserResponse>> _value;
    try {
      _value = ApiResponse<PaginatedResponse<UserResponse>>.fromJson(
        _result.data!,
        (json) => PaginatedResponse<UserResponse>.fromJson(
