...
class _TransactionApi implements TransactionApi {
  ...
  Future<ApiResponse<PaginatedResponse<TransactionResponse>>> getTransactions(
    ...
    late ApiResponse<PaginatedResponse<TransactionResponse>> _value;
    try {
      _value = ApiResponse<PaginatedResponse<TransactionResponse>>.fromJson(
        _result.data!,
        (json) => PaginatedResponse<TransactionResponse>.fromJson(
